Feature: 보관함 (Mweb)
  ...
  @TC-161M @smoke
  Scenario: [TPS-161M] 모바일 보관함 Recent — 작품 클릭 시 뷰어 진입 후 Recent 복귀
  ...
  @TC-164M @smoke
  Scenario: [TPS-164M] 모바일 보관함 Subscribed — 작품 클릭 시 작품홈 진입
  ...
  @TC-169M @smoke
  Scenario: [TPS-169M] 모바일 보관함 Free episodes — 작품 클릭 시 작품홈 진입
  ...
  @TC-172M @smoke
  Scenario: [TPS-172M] 모바일 보관함 Wait until Free — 작품 클릭 시 작품홈 진입
