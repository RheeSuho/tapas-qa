...
Feature: 하단 툴바
  ...
  @TC-0203
  Scenario: [TPS-097] 이전 회차 이동 - 기다무 이용권
    Given 이전회차 : 기다무 회차
    And 기다무 이용권 있음
  ...
  @TC-0204
  Scenario: [TPS-098] 이전 회차 이동 - 대여 이용권
    Given 이전회차 : 유료회차
    And 대여 이용권 있음
    When 뷰어 하단 툴바 > [이전회차] 버튼 클릭
    And [Unlock Episode] 버튼 클릭
  ...
  @TC-0205
  Scenario: [TPS-099] 이전 회차 이동 - 선물 이용권
    Given 이전회차 : 유료회차
    And 선물 이용권 있음
    When 뷰어 하단 툴바 > [이전회차] 버튼 클릭
    And [Unlock Episode] 버튼 클릭
  ...
  @TC-0206
  Scenario: [TPS-100] 이전 회차 이동 - 잉크 구매
    Given 이전회차 : 유료회차
    And 보유 이용권 없음
    And 보유 잉크 >= 회차 금액
    When 뷰어 하단 툴바 > [이전회차] 버튼 클릭
  ...
  @TC-0207
  Scenario: [TPS-101] 이전 회차 이동 - 잉크 부족
    Given 이전회차 : 유료회차
    And 보유 이용권 없음
    And 보유 잉크 < 회차 금액
    When 뷰어 하단 툴바 > [이전회차] 버튼 클릭
  ...
  @TC-0208
  Scenario: [TPS-102] 다음 회차 이동 - 기다무 이용권
    Given 다음회차 : 기다무 회차
    And 기다무 이용권 있음
  ...
  @TC-0209
  Scenario: [TPS-103] 다음 회차 이동 - 대여 이용권
    Given 다음회차 : 유료회차
    And 대여 이용권 있음
    When 뷰어 하단 툴바 > [다음회차] 버튼 클릭
    And [Unlock Episode] 버튼 클릭
  ...
  @TC-0210
  Scenario: [TPS-104] 다음 회차 이동 - 선물 이용권
    Given 다음회차 : 유료회차
    And 선물 이용권 있음
    When 뷰어 하단 툴바 > [다음회차] 버튼 클릭
    And [Unlock Episode] 버튼 클릭
  ...
  @TC-0211
  Scenario: [TPS-105] 다음 회차 이동 - 잉크 구매
    Given 다음회차 : 유료회차
    And 보유 이용권 없음
    And 보유 잉크 >= 회차 금액
    When 뷰어 하단 툴바 > [다음회차] 버튼 클릭
  ...
  @TC-0212
  Scenario: [TPS-106] 다음 회차 이동 - 잉크 부족
    Given 다음회차 : 유료회차
    And 보유 이용권 없음
    And 보유 잉크 < 회차 금액
    When 뷰어 하단 툴바 > [다음회차] 버튼 클릭
