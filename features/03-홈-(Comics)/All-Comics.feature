...
Feature: All Comics (장르전체 랜딩 서브탭)
  ...
  @TC-0039
  Scenario: [TPS-030] All Comics 서브탭 클릭 + 정렬/필터 노출 확인
  ...
  @TC-0040
  Scenario: [TPS-031] 장르 선택 필터 버튼 클릭 + 장르 선택 팝업 > 장르명 선택 후 Confirm 버튼 클릭
    When 장르 선택 필터 버튼 클릭
  ...
  @TC-0041
  Scenario: [TPS-032] 정렬 옵션 변경 버튼 클릭 + 정렬 선택 팝업 > 정렬값 선택 후 Confirm 버튼 클릭
    When 정렬 옵션 변경 버튼 클릭
