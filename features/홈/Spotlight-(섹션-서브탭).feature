...
Feature: Spotlight (섹션 서브탭)
  ...
  @TC-0017
  Scenario: [TPS-205] Top 섹션 - 빅배너 - 클릭
    When 빅배너 클릭
  ...
  @TC-0020
  Scenario: [TPS-208] 최근 본 작품 섹션
    When 섹션 노출 확인
    Then 최근 본 작품 노출된다.

  @TC-0021
  Scenario: [TPS-209] 배너 섹션
    When 섹션 노출 확인
    And 배너 클릭
    And 상단네비바 [<] 또는 단말 백버튼 클릭
