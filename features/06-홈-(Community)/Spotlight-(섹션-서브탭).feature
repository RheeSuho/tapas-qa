...
Feature: Spotlight (섹션 서브탭)
  ...
  @TC-0060
  Scenario: [TPS-083] Top 섹션 - 빅배너 - 클릭
    When 빅배너 클릭
    And 상단네비바 [<] 또는 단말 백버튼 클릭
    Then 빅배너 랜딩타겟으로 이동된다.
    And 이전 화면으로 돌아온다. (Community 홈)

  @TC-0061
  Scenario: [TPS-084] Top 섹션 - 카드배너
