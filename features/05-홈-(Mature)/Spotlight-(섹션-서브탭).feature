...
Feature: Spotlight (섹션 서브탭)
  ...
  @TC-0071
  Scenario: [TPS-064] 미로그인 / 미인증 - 딤드 노출
  ...
  @TC-0072
  Scenario: [TPS-065] 미로그인 / 미인증 - 연령 인증
    Given 미로그인 / 미인증 상태
  ...
  @TC-0076
  Scenario: [TPS-069] Top 섹션 - 빅배너 - 클릭
    When 빅배너 클릭
