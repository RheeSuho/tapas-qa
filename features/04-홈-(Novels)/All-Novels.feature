...
Feature: All Novels (장르전체 랜딩 서브탭)
  ...
  @TC-0053
  Scenario: [TPS-043] All Novels 서브탭 클릭 + 정렬/필터 노출 확인
    ...
    And Novel 작품의 모든 장르에 해당하는 작품이 노출된다.

  @TC-0054
  Scenario: [TPS-044] 장르 선택 필터 버튼 클릭 + 장르 선택 팝업 > 장르명 선택 후 Confirm 버튼 클릭
    When 장르 선택 필터 버튼 클릭
  ...
  @TC-0055
  Scenario: [TPS-045] 정렬 옵션 변경 버튼 클릭 + 정렬 선택 팝업 > 정렬값 선택 후 Confirm 버튼 클릭
    When 정렬 옵션 변경 버튼 클릭
