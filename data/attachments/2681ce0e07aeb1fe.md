...
- Location: .features-gen/features/12-보관함/Subscribed.feature.spec.js:40:7
...
Locator: locator('a.item-title[href*="SUBSCRIBED"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a.item-title[href*="SUBSCRIBED"]')
