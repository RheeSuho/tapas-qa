...
- generic [ref=e1]:
  - generic [ref=e3]:
    ...
    - main [ref=e126]:
      ...
      - generic [ref=e150]:
        - article [ref=e151]:
          - link "wuf NEW 156.6K" [ref=e152] [cursor=pointer]:
            - /url: /series/326810
            - generic "The Youngest Has Much To Hide" [ref=e153]:
              - generic [ref=e161]:
                - img "wuf" [ref=e163]
                - generic [ref=e164]: NEW
              - generic [ref=e169]: 156.6K
        - article [ref=e170]:
        ...
        - article [ref=e189]:
          - link "wuf NEW 160.5K" [ref=e190] [cursor=pointer]:
            - /url: /series/326798
            - generic "My Husband's a Possessed Hero" [ref=e191]:
              - generic [ref=e199]:
                - img "wuf" [ref=e201]
                - generic [ref=e202]: NEW
              - generic [ref=e207]: 160.5K
        - article [ref=e208]:
        ...
        - article [ref=e281]:
          - link "wuf 162K" [ref=e282] [cursor=pointer]:
            - /url: /series/325468
            - generic "The Mastermind Is My Housekeeper" [ref=e283]:
              - img "wuf" [ref=e293]
              - generic [ref=e298]: 162K
        - article [ref=e299]:
        ...
        - article [ref=e388]:
          - link "wuf 698.4K" [ref=e389] [cursor=pointer]:
            - /url: /series/286094
            - generic "I Have Never Abandoned the Tyrant" [ref=e390]:
              - img "wuf" [ref=e400]
              - generic [ref=e405]: 698.4K
        - article [ref=e406]:
        ...
        - article [ref=e549]:
          - link "wuf 994.5K" [ref=e550] [cursor=pointer]:
            - /url: /series/294154
            - generic "Ending This Marriage for Your Happiness" [ref=e551]:
              - img "wuf" [ref=e561]
              - generic [ref=e566]: 994.5K
        - article [ref=e567]:
...
> 208 |   await spotlight.first().click();
  ...
  210 |   const banner = page.locator('a[href*="/event/"], a[href*="/series/"]').filter({ has: page.locator('img') });
  211 |   if ((await banner.count()) === 0) { test.skip(true, 'Comics Spotlight 콘텐츠 미운영 상태'); return; }
  212 | });
  213 | 
  ...
  231 |   const banner = page.locator('a[href*="/event/"], a[href*="/series/"]').filter({ has: page.locator('img') });
  232 |   if ((await banner.count()) === 0) { test.skip(true, 'Novels Spotlight 콘텐츠 미운영 상태'); return; }
  233 | });
  234 | 
  ...
  252 |   const banner = page.locator('a[href*="/event/"], a[href*="/series/"]').filter({ has: page.locator('img') });
  253 |   if ((await banner.count()) === 0) { test.skip(true, 'Mature Spotlight 콘텐츠 미운영 상태'); return; }
  254 | });
  255 | 
  ...
  284 |   if ((await spotlight.count()) === 0) { test.skip(true, 'Community Spotlight 서브탭 미운영 상태'); return; }
  285 |   await spotlight.first().click();
  286 |   await page.waitForLoadState('domcontentloaded').catch(() => {});
  287 |   const banner = page.locator('a[href*="/event/"], a[href*="/series/"]').filter({ has: page.locator('img') });
  288 |   if ((await banner.count()) === 0) { test.skip(true, 'Community Spotlight 콘텐츠 미운영 상태'); return; }
  289 | });
  290 | 
  291 | Then('Community 홈으로 돌아온다', async ({ page }) => {
  292 |   await expect(page.locator('article a[href*="/series/"]').first()).toBeVisible({ timeout: 10000 });
  293 | });
  294 | 
  295 | Then('Community 카테고리 페이지가 노출된다', async ({ page }) => {
  296 |   await expect(page.locator('article a[href*="/series/"]').first()).toBeVisible({ timeout: 10000 });
  297 | });
  298 | 
  299 | // ──── 결과 검증 ────
  300 | 
  301 | Then(/^(Comics|Novels|Community|mature) 홈화면의 첫 번째 서브탭으로 진입된다\.$/, async ({ page }, category: string) => {
  302 |   // 작품 카드 노출 확인
  303 |   await expect(page.locator('article a[href*="/series/"]').first()).toBeVisible({ timeout: 10000 });
  304 |   // Comics/Novels는 Daily 탭(요일 버튼)도 같이 확인
  305 |   if (category === 'Comics' || category === 'Novels') {
  306 |     const dayTab = page.locator('a[href*="daily_type="]').first();
  307 |     const isVisible = await dayTab.isVisible().catch(() => false);
  308 |     if (isVisible) { await expect(dayTab).toBeVisible(); }
```