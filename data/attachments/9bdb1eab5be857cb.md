...
- Name: ../.features-gen/features/12-보관함/Recent.feature.spec.js >> Recent >> [TPS-174] Recent 클릭 + GNB 보관함 아이콘 클릭 > Recent 클릭
- Location: .features-gen/features/12-보관함/Recent.feature.spec.js:6:7
...
Locator: locator('a.item-title[href*="RECENT"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a.item-title[href*="RECENT"]')
