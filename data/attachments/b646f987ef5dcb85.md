...
- Name: ../.features-gen/features/03-홈-(Comics)/Spotlight.feature.spec.js >> Spotlight (섹션 서브탭) >> [TPS-037] 빅배너 클릭 + Comics 홈으로 복귀
- Location: .features-gen/features/03-홈-(Comics)/Spotlight.feature.spec.js:24:7
