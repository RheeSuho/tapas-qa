...
Call log:
  ...
  - waiting for locator('.gnb-dropdown a, .gnb-more-menu a, nav[class*="more"] a, a[href*="/account/"]').first()
    7 × locator resolved to <a href="/account/signout" data-tiara-click-layer1="top" data-amp-braze-event="user_logout" data-tiara-action-name="log_out_click" class="js-tiara-tracking-nav content__row js-amp-tracking js-braze-tracking">…</a>
