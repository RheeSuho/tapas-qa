...
- Name: ../.features-gen/features/15-Profile/기타.feature.spec.js >> 기타 >> [TPS-209] 로그인 상태 > Profile 클릭 + Profile 영역 확인
- Location: .features-gen/features/15-Profile/기타.feature.spec.js:6:7
...
- generic [active] [ref=e1]:
  ...
  - alert [ref=e1401]
  - iframe [ref=e1402]:
    - button "Help" [ref=f5e4] [cursor=pointer]:
      - img [ref=f5e6]
      - generic [ref=f5e13]: Help
```
